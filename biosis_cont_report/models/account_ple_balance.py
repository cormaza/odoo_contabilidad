...
class PleBalanceComprobacion(models.Model):
    ...
    @api.multi
    def get_ple_bc(self, company_id, fecha_reporte, fecha_inicio, fecha_fin):
        ple_bc_res = ''
        ...
        if len(bc_ple_new) > 0:
            ...
            """
            ple_nuevos = self.create_ple_items_bc(company_id, bc_ple_new, fecha_reporte, fecha_inicio, fecha_fin)
        ...
        if len(bc_ple_list) > 0:
            """
             ...
             """
            ple_old = self.update_ple_items_bc(company_id, bc_ple_old, bc_ple_update, fecha_reporte, fecha_inicio, fecha_fin)
    ...
    @api.multi
    def create_ple_items_bc(self, company_id, account_lines, fecha_reporte, fecha_inicio, fecha_fin):
        ple_items = ''
    ...
    @api.multi
    def update_ple_items_bc(self, company_id, bc_ple_old, bc_ple_update, fecha_reporte, fecha_inicio, fecha_fin):
        ple_items = ''
