...
class PleDiario(models.Model):
    ...
    def get_ple_diario(self, company_id, fecha_reporte, fecha_inicio, fecha_fin):
        ple_diario_res = ''
        ...
        if len(move_nuevos) > 0:
            ple_nuevos = self.create_ple_items_diario(company_id, move_nuevos, fecha_reporte, fecha_inicio, fecha_fin)
            ple_diario_res = ple_diario_res + ple_nuevos

        if len(move_old) > 0:
            ple_modificados = self.update_ple_items_diario(company_id, move_old, fecha_reporte, fecha_inicio, fecha_fin)
            ple_diario_res = ple_diario_res + ple_modificados

        return ple_diario_res

    @api.multi
    def create_ple_items_diario(self, company_id, move_nuevos, fecha_reporte, fecha_inicio, fecha_fin):
        ple_items = ''
    ...
    @api.multi
    def update_ple_items_diario(self, company_id, move_olds, fecha_reporte, fecha_inicio, fecha_fin):
        ple_items = ''
