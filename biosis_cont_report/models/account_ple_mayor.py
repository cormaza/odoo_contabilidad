...
class PleMayor(models.Model):
    ...
    @api.multi
    def get_ple_mayor(self, company_id, fecha_reporte, fecha_inicio, fecha_fin):
        ple_mayor_res = ''
        ...
        if len(move_nuevos) > 0:
            ple_nuevos = self.create_ple_items_mayor(company_id, move_nuevos, fecha_reporte, fecha_inicio, fecha_fin)
            ple_mayor_res = ple_mayor_res + ple_nuevos

        if len(move_old) > 0:
            ple_modificados = self.update_ple_items_mayor(company_id, move_old, fecha_reporte, fecha_inicio, fecha_fin)
            ple_mayor_res = ple_mayor_res + ple_modificados

        return ple_mayor_res

    @api.multi
    def create_ple_items_mayor(self, company_id, move_nuevos, fecha_reporte, fecha_inicio, fecha_fin):
        ple_items = ''
    ...
    @api.multi
    def update_ple_items_mayor(self, company_id, move_olds, fecha_reporte, fecha_inicio, fecha_fin):
        ple_items = ''
