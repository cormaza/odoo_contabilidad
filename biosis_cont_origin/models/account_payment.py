...
class AccountPayment(models.Model):
    ...
    def default_get(self, fields):
        ...
        if factura.invoice_line_ids:
            for line in factura.invoice_line_ids:
                if line.product_id.cuenta_detraccion_venta.id != False:
                    bandera = 1
    ...
    def _create_payment_entry(self, amount):
        ...
        #self.aplica_detraccion = False
        #método para actualizar los residuales de factura/detraccion
        # bandera = 0
        # if self.invoice_ids.id != False:
        #     if self.invoice_ids.invoice_line_ids:
        #         for line in self.invoice_ids.invoice_line_ids:
        #             if line.product_id.cuenta_detraccion_venta.id != False:
        #                 bandera = 1
        # if bandera == 1:
        #     self.aplica_detraccion = True
        #     self.calculo_residual_factura_detraccion()

        # if self.invoice_ids.id != False:
        #     if self.invoice_ids.invoice_line_ids.product_id.cuenta_detraccion_venta.id != False:
        #         self.aplica_detraccion = True
        #         self.calculo_residual_factura_detraccion()
