...
class ReportFacturasClienteWizard(models.TransientModel):
    _name = 'report.ventas.wizard'
    ...
    @api.multi
    def print_reportfacturascliente_xls(self):
        self.ensure_one()
        return {
            'type': 'ir.actions.act_url',
            'url': '/reports/report_ventas?fecha_inicio='+ self.date_from +'&fecha_fin='+ self.date_to+'',
